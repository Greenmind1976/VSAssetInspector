...
MOD_OUTPUT_DIR="$ROOT_DIR/VSAssetInspector/bin/Release/net8.0/Mods/mod"
...
VINTAGE_STORY="$VS_APP_DIR" dotnet build "$PROJECT_PATH" -c Release -f net8.0 -p:NuGetAudit=false
